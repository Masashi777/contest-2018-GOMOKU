...
def CanOpponentHaveThreeStones(field, position):
    return (CountOppopnetnStonesOnLine(field, position, (1, 1)) >= 3 or
            CountOppopnetnStonesOnLine(field, position, (1, 0)) >= 3 or
            CountOppopnetnStonesOnLine(field, position, (1, -1)) >= 3 or
            CountOppopnetnStonesOnLine(field, position, (0, 1)) >= 3)
