...
def scoring(field):
    ...
    for i in range(N):
        for j in range(N):
            ...
            nume4 = CanHaveNStones(field, 4, 'X')
            nume3 = CanHaveNStones(field, 3, 'X')
            nume2 = CanHaveNStones(field, 2, 'X')

            score = num4*99999 + num3*300 + num2*200
            if score > best_score:
                best_score = score

    return num4*99999 + num3*300 + num2*200 - best_score
